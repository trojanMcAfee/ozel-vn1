...
contract OZLrewards is Modifiers { //check if I can put IOZLrewards here instead of Modifiers
    ...
    ^^^ finish up checking this and the continue with test_multiple_OZL_claim
    ...
    function setRewardDataExternally(address user_) external { //put an onlySomething modifier here
