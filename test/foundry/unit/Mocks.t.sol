...
contract MocksTests is MockStorage, TestMethods {
    ...
    //Delete all contracts/funcs connected to this test since it's not necessary as
    //I have the TWAP tests which are what's used 
    ...
    //     assertTrue(ozERC20.balanceOf(bob) + ozBalanceAlice + 1 == ozERC20.totalSupply());
