...
contract ozExecutorTest is Setup {
    ...
    function test_unauth_access_direct_useUnderlying() public {
        ...
        vm.prank(alice);
        ozIDiamond(address(executor)).useUnderlying(address(0), address(0), amts);
    }
    ...
    function test_unauth_access_direct_useOzTokens() public {
        ...
        vm.prank(alice);
        ozIDiamond(address(executor)).useOzTokens(address(0), new bytes(0));
    }
